...
for the specific act of composing from the composer-programmer's perspective.
...
Thus, the project should satisfy all of these criteria:
...
physical instruments that interact with the program.
...
feel they need to use a general purpose language.
...
----------------------------------------------------------------------------------------------------
A common problem with many of the existing computer music DSLs is that they were designed with the
...
----------------------------------------------------------------------------------------------------
Finally, a goal of the project is to ensure that all of the goals so far can be achieved in a way that 
